package yapimath.range;

import yapimath.NumberUtils;
...
public class RangeSimple {
    ...
    protected static String[] splitRange(String string, String[] splitStrings, boolean reviveSplitted, boolean addToLast) {
        ...
        if (string.isEmpty()) throw new RangeException("No String");
        if (splitStrings.length == 0) throw new RangeException("No Split Strings");
